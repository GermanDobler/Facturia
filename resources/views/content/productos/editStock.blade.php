...
@section('content')
    ...
    <div class="card">
        <form action="{{ route('productos.updateStock', $producto->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="card-body">
                ...
                <div class="card-header d-flex justify-content-between p-0 pb-2">
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="portada" disabled name="portada" value="1"
    ...
    <input type="number" name="precio" id="precio" value="{{ old('precio', $producto->precio) }}" disabled class="form-control">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="categoria_id" name="categoria_id" disabled required>
                ...
                <div class="mb-3">
                    ...
                    <div class="col-sm-12">
                        ...
                        <input type="file" class="form-control" id="imagenes" name="imagenes[]" disabled multiple> --}}
