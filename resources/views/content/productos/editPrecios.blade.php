...
@section('content')
    ...
    <div class="card">
        <form action="{{ route('productos.updatePrecios', $producto->id) }}" method="POST" enctype="multipart/form-data"
    ...
    <input type="number" name="precio" id="precio" value="{{ old('precio', $producto->precio) }}" class="form-control">
